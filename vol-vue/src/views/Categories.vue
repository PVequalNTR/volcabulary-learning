    ...
    <div class="justify-center flex">
        <div class="w-3/5 mt-6">
            ...
            <div class="grid grid-cols-6 gap-4 mt-8">
                <router-link v-for="item of categories_list" :to="{ path:'/categories/view', query:{name:item.name}}" class="p-4 rounded-lg shadow-lg bg-indigo-400 text-white text-center" >
                {{ item.name }}
                </router-link>
